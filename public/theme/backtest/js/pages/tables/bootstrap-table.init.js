...
function operateFormatter(value, row, index) {
  return [
    '<a class="like link" href="javascript:void(0)" title="Like">',
    '<i class="ri-heart-line fs-5"></i>',
    "</a>  ",
    '<a class="remove link" href="javascript:void(0)" title="Remove">',
...
function initTable() {
  $table.bootstrapTable("destroy").bootstrapTable({
    ...
    locale: $("#locale").val(),
    icons: {
      paginationSwitchDown: "ri-arrow-down-s-line fs-5",
      paginationSwitchUp: "ri-arrow-up-s-line fs-5",
      refresh: "ri-refresh-line fs-5",
      toggleOff: "ri-toggle-line fs-5",
      toggleOn: "ri-toggle-fill fs-5",
      columns: "ri-list-unordered fs-5",
      fullscreen: "ri-fullscreen-line fs-5",
      detailOpen: "ri-add-circle-line fs-5",
      detailClose: "ri-close-circle-line fs-5",
      export: "ri-share-line fs-5",
    },
    columns: [
      [
        {
