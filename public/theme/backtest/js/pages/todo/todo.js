...
$(".add-tsk").click(function (e) {
  ...
  $html =
    ...
    '<input type="checkbox" class="form-check-input flex-shrink-0 me-3" id="' +
    cdate +
    '">' +
    ...
    $_taskDescriptionText +
    "</div>" +
    '<span class="todo-time fs-2 mt-2 text-muted">' +
    today +
    "</span>" +
    "</div>" +
    '<div class="ms-auto">' +
    ...
    '<a class="edit dropdown-item" href="javascript:void(0);"><div class="d-flex align-items-center"><i class="ri-edit-box-line fs-5 text-info me-2"></i>Edit</div></a>' +
    '<a class="important dropdown-item" href="javascript:void(0);"><div class="d-flex align-items-center"><i class="ri-star-fill fs-5 text-warning me-2"></i>Important</div></a>' +
    '<a class="remove dropdown-item" href="javascript:void(0);"><div class="d-flex align-items-center"><i class="ri-delete-bin-line fs-5 text-danger me-2"></i>Remove</div></a>' +
    '<a class="dropdown-item permanent-delete" href="javascript:void(0);"><div class="d-flex align-items-center"><i class="ri-delete-bin-6-line fs-5 text-danger me-2"></i>Permanent Delete</div></a>' +
    '<a class="dropdown-item revive" href="javascript:void(0);"><div class="d-flex align-items-center"><i class="ri-refresh-line fs-5 text-success me-2"></i>Revive Task</div></a>' +
    "</div>" +
    "</div>" +
    "</div>" +
    "</div>" +
