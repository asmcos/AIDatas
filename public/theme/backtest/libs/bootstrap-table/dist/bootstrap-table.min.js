...
!(function (a) {
  ...
  var d = {
      3: {
        ...
        icons: {
          paginationSwitchDown: "glyphicon-collapse-down ri-arrow-down-s-line",
          paginationSwitchUp: "glyphicon-collapse-up ri-arrow-up-s-line",
          refresh: "glyphicon-refresh ri-refresh-line",
          toggleOff: "glyphicon-list-alt ri-list-check",
          toggleOn: "glyphicon-list-alt ri-list-check",
          columns: "ri-file-list-line",
          detailOpen: "glyphicon-plus ri-add-line",
          detailClose: "glyphicon-minus ri-subtract-line",
          fullscreen: "glyphicon-fullscreen ri-fullscreen-line",
        },
        pullClass: "pull",
        toobarDropdowHtml: ['<ul class="dropdown-menu" role="menu">', "</ul>"],
        toobarDropdowItemHtml:
          '<li role="menuitem"><label class="dropdown-item py-3">%s</label></li>',
      ...
      4: {
        ...
        icons: {
          ...
          toggleOff: "ri-toggle-line",
          toggleOn: "ri-toggle-fill",
          columns: "fa-th-list",
          detailOpen: "ri-add-line",
          detailClose: "ri-subtract-line",
    ...
    j = function (b, c, d, e) {
      ...
      return "object" == typeof g
        ...
        : "function" == typeof g
        ? g.apply(b, d || [])
        : !g && "string" == typeof c && f.apply(this, [c].concat(d))
        ? f.apply(this, [c].concat(d))
        : e;
    },
    k = function (b, c, d) {
      var e =
  ...
  (q.DEFAULTS = {
    ...
    a.extend(q.DEFAULTS, q.LOCALES["en-US"]),
    (q.COLUMN_DEFAULTS = {
      radio: !1,
      checkbox: !1,
      checkboxEnabled: !0,
    ...
    (q.prototype.initLocale = function () {
      if (this.options.locale) {
        ...
        b[0].toLowerCase(),
          b[1] && b[1].toUpperCase(),
          a.fn.bootstrapTable.locales[this.options.locale]
            ? a.extend(
                this.options,
                a.fn.bootstrapTable.locales[this.options.locale]
              )
            : a.fn.bootstrapTable.locales[b.join("-")]
            ? a.extend(this.options, a.fn.bootstrapTable.locales[b.join("-")])
            : a.fn.bootstrapTable.locales[b[0]] &&
              a.extend(this.options, a.fn.bootstrapTable.locales[b[0]]);
      }
    }),
    (q.prototype.initContainer = function () {
      (this.$container = a(
        [
          ...
          '<div class="fixed-table-toolbar d-md-flex align-items-center"></div>',
        ...
        (this.$toolbar = this.options.buttonsToolbar
          ? a("body").find(this.options.buttonsToolbar)
        ...
        -1 !==
          a.inArray("table-no-bordered", this.options.classes.split(" ")) &&
      ...
      if (
        ...
        this.$header.find("tr").each(function () {
          ...
          a(this)
            .find("th")
            .each(function () {
              "undefined" != typeof a(this).data("field") &&
                a(this).data("field", a(this).data("field") + ""),
                b.push(
                  a.extend(
                    {},
                    {
          ...
          (f._id = a(this).attr("id")),
            ...
            a(this)
              ...
              .each(function (d) {
                ...
                (f[l] = a(this).html()),
                  (f["_" + l + "_id"] = a(this).attr("id")),
                  (f["_" + l + "_class"] = a(this).attr("class")),
                  (f["_" + l + "_rowspan"] = a(this).attr("rowspan")),
                  (f["_" + l + "_colspan"] = a(this).attr("colspan")),
                  (f["_" + l + "_title"] = a(this).attr("title")),
                  (f["_" + l + "_data"] = m(a(this).data()));
              }),
            d.push(f);
        }),
          (this.options.data = d),
    ...
    (q.prototype.initHeader = function () {
      ...
      (this.header = {
          ...
          d.push("<tr>"),
            ...
            a.each(g, function (a, e) {
              ...
              if (
                ...
                e.width &&
                  "string" == typeof e.width &&
                  (n = e.width.replace("%", "").replace("px", "")),
                (h = f("text-align: %s; ", e.halign ? e.halign : e.align)),
                (i = f("text-align: %s; ", e.align)),
                (j = f("vertical-align: %s; ", e.valign)),
                (j += f(
                  "width: %s; ",
                  (!e.checkbox && !e.radio) || n
                    ? n
                      ? n + m
                      : void 0
                    : e.showSelectTitle
                ...
                if (
                  ((b.header.fields[e.fieldIndex] = e.field),
                  (b.header.styles[e.fieldIndex] = i + j),
                  (b.header.classes[e.fieldIndex] = k),
                  (b.header.formatters[e.fieldIndex] = e.formatter),
                  (b.header.events[e.fieldIndex] = e.events),
                  (b.header.sorters[e.fieldIndex] = e.sorter),
                  (b.header.sortNames[e.fieldIndex] = e.sortName),
                  (b.header.cellStyles[e.fieldIndex] = e.cellStyle),
                  (b.header.searchables[e.fieldIndex] = e.searchable),
                  !e.visible)
                )
                  return;
              ...
              d.push(
                "<th" + f(' title="%s"', e.titleTooltip),
                e.checkbox || e.radio
                  ? f(' class="bs-checkbox %s"', e["class"] || "")
                  : k,
                f(' style="%s"', h + j),
                f(' rowspan="%s"', e.rowspan),
                f(' colspan="%s"', e.colspan),
                f(' data-field="%s"', e.field),
                0 === a && e.fieldIndex ? " data-not-first-th" : "",
                ">"
              ),
                d.push(
                  f(
                    '<div class="th-inner %s">',
                    b.options.sortable && e.sortable ? "sortable both" : ""
                  )
                ),
                (g = b.options.escape ? l(e.title) : e.title);
              var o = g;
              e.checkbox &&
                ((g = ""),
                !b.options.singleSelect &&
                  b.options.checkboxHeader &&
                  (g = '<input name="btSelectAll" type="checkbox" />'),
                (b.header.stateField = e.field)),
                e.radio &&
                  ((g = ""),
                  (b.header.stateField = e.field),
                  (b.options.singleSelect = !0)),
                !g && e.showSelectTitle && (g += o),
                d.push(g),
                d.push("</div>"),
        ...
        this.$container
          .off("click", ".th-inner")
          .on("click", ".th-inner", function (c) {
            var d = a(this);
            return b.options.detailView &&
              !d.parent().hasClass("bs-checkbox") &&
              d.closest(".bootstrap-table")[0] !== b.$container[0]
              ? !1
              : void (
                  b.options.sortable &&
                  d.parent().data().sortable &&
                  b.onSort(c)
                );
          }),
        this.$header
    ...
    (q.prototype.initData = function (a, b) {
      (this.options.data =
        "append" === b
          ? this.options.data.concat(a)
          : "prepend" === b
          ? [].concat(a).concat(this.options.data)
          : a || this.options.data),
    ...
    (q.prototype.initSort = function () {
      var b = this,
        ...
        g = 0;
      return this.options.customSort !== a.noop
        ...
        : void (
            ...
            this.data.sort(function (f, g) {
              ...
              return void 0 !== k
                ? b.options.sortStable && 0 === k
                  ? f._position - g._position
                  : d * k
                : ((void 0 === h || null === h) && (h = ""),
                  (void 0 === i || null === i) && (i = ""),
                  b.options.sortStable && h === i
                    ? ((h = f._position),
                      (i = g._position),
                      f._position - g._position)
                    : a.isNumeric(h) && a.isNumeric(i)
                    ? ((h = parseFloat(h)),
                      (i = parseFloat(i)),
                      i > h ? -1 * d : d)
                    : h === i
                    ? 0
                    : ("string" != typeof h && (h = h.toString()),
            ...
            void 0 !== this.options.sortClass &&
              ...
              (g = setTimeout(function () {
                ...
                var a = b.$header.find(
                  f('[data-field="%s"]', b.options.sortName).index() + 1
                );
                b.$el
                  .find(f("tr td:nth-child(%s)", a))
                  .addClass(b.options.sortClass);
              }, 250))))
          );
    }),
    (q.prototype.onSort = function (b) {
      var c =
          "keypress" === b.type
            ? a(b.currentTarget)
            : a(b.currentTarget).parent(),
        d = this.$header.find("th").eq(c.index());
      return (
        this.$header.add(this.$header_).find("span.order").remove(),
        this.options.sortName === c.data("field")
          ? (this.options.sortOrder =
          ...
          : ((this.options.sortName = c.data("field")),
            (this.options.sortOrder = this.options.rememberOrder
              ? "asc" === c.data("order")
                ? "desc"
                : "asc"
              : this.columns[this.fieldsColumnsIndex[c.data("field")]].order)),
    ...
    (q.prototype.initToolbar = function () {
      ...
      this.$toolbar.find(".bs-bars").children().length &&
        ...
        "string" == typeof this.options.icons &&
          (this.options.icons = j(null, this.options.icons)),
        this.options.showPaginationSwitch &&
          g.push(
            f(
              '<button class="btn' +
                f(" btn-%s", this.options.buttonsClass) +
                f(" btn-%s", this.options.iconSize) +
        ...
        this.options.showFullscreen &&
          this.$toolbar
            ...
            .off("click")
            .on("click", a.proxy(this.toggleFullscreen, this)),
        ...
        this.options.showColumns &&
          (g.push(
            ...
            "</button>",
            d.toobarDropdowHtml[0]
          ),
          a.each(this.columns, function (a, b) {
            if (
              !(b.radio || b.checkbox || (e.options.cardView && !b.cardVisible))
            ) {
              var c = b.visible ? ' checked="checked"' : "";
              b.switchable &&
                (g.push(
                  f(
                    d.toobarDropdowItemHtml,
                    f(
          ...
          g.push(d.toobarDropdowHtml[1], "</div>")),
        g.push("</div>"),
        ...
        this.options.showPaginationSwitch &&
          this.$toolbar
            ...
            .off("click")
            .on("click", a.proxy(this.togglePagination, this)),
        this.options.showRefresh &&
          this.$toolbar
            .find('button[name="refresh"]')
            .off("click")
            .on("click", a.proxy(this.refresh, this)),
        this.options.showToggle &&
          this.$toolbar
        ...
        this.options.showColumns &&
          ((b = this.$toolbar.find(".keep-open")),
          i <= this.options.minimumCountColumns &&
        ...
        this.options.search &&
          ...
          g.push(
            f(
              '<div class="%s-%s search w-25 ms-auto">',
              d.pullClass,
              this.options.searchAlign
            ),
            f(
              '<input class="form-control' +
                f(" input-%s", this.options.iconSize) +
                '" type="text" placeholder="%s">',
              this.options.formatSearch()
            ),
            "</div>"
          ),
          this.$toolbar.append(g.join("")),
          (c = this.$toolbar.find(".search input")),
          c.off("keyup drop blur").on("keyup drop blur", function (b) {
            (e.options.searchOnEnterKey && 13 !== b.keyCode) ||
          ...
          o() &&
            c.off("mouseup").on("mouseup", function (a) {
              clearTimeout(h),
                (h = setTimeout(function () {
                  e.onSearch(a);
                }, e.options.searchTimeOut));
    ...
    (q.prototype.initSearch = function () {
      ...
      if ("server" !== this.options.sidePagination) {
        ...
        (this.data = d
          ? a.grep(this.options.data, function (b) {
              for (var c in d)
                if (
                  (a.isArray(d[c]) && -1 === a.inArray(b[c], d[c])) ||
                  (!a.isArray(d[c]) && b[c] !== d[c])
                )
                  return !1;
              return !0;
            })
            ...
            ? a.grep(this.data, function (d, e) {
                for (var f = 0; f < b.header.fields.length; f++)
                  if (b.header.searchables[f]) {
                    var g,
                      h = a.isNumeric(b.header.fields[f])
                        ? parseInt(b.header.fields[f], 10)
                        : b.header.fields[f],
    ...
    (q.prototype.initPagination = function () {
      ...
      if (
        ...
        if (this.options.pageSize === this.options.formatAllRows())
          (this.options.pageSize = this.options.totalRows), (m = !0);
          ...
          var p =
            "string" == typeof this.options.pageList
              ? this.options.pageList
                  ...
                  .split(",")
              : this.options.pageList;
          a.inArray(this.options.formatAllRows().toLowerCase(), p) > -1 &&
            (m = !0);
        }
        (this.totalPages =
      ...
      if (
        ...
        var q = [
          ...
          m ? this.options.formatAllRows() : this.options.pageSize,
          "</span>",
          ' <span class="caret"></span>',
          "</button>",
        ...
        if ("string" == typeof this.options.pageList) {
          ...
          (o = []),
            a.each(r, function (a, b) {
              o.push(
                b.toUpperCase() === k.options.formatAllRows().toUpperCase() ||
                  "UNLIMITED" === b.toUpperCase()
                  ? k.options.formatAllRows()
                  : +b
              );
            });
        }
        for (
          a.each(o, function (a, b) {
            if (
              !k.options.smartDisplay ||
              0 === a ||
              o[a - 1] < k.options.totalRows
            ) {
              var c;
              (c = m
                ? b === k.options.formatAllRows()
                  ? "active"
                  : ""
                : b === k.options.pageSize
                ? "active"
                : ""),
                q.push(f(d.pageDropdownItemHtml, c, b));
            }
          }),
            q.push(d.pageDropdownHtml[1] + "</span>"),
            l.push(this.options.formatRecordsPerPage(q.join(""))),
            l.push("</span>"),
            l.push(
              "</div>",
              f(
              ...
              '<ul class="pagination' +
                f(" pagination-%s", this.options.iconSize) +
                '">',
              f(
            ...
            this.totalPages < 5
              ? ((c = 1), (e = this.totalPages))
              : ((c = this.options.pageNumber - 2),
                (e = c + 4),
                1 > c && ((c = 1), (e = 5)),
                e > this.totalPages && ((e = this.totalPages), (c = e - 4))),
            this.totalPages >= 6 &&
            ...
            this.totalPages >= 7 &&
              ...
              c--,
            6 == this.totalPages
              ? this.options.pageNumber >= this.totalPages - 2 && e++
              : this.totalPages >= 7 &&
                (7 == this.totalPages ||
          ...
          l.push(
            f(
              ...
              b === this.options.pageNumber ? " active" : ""
            ),
            '<a class="page-link" href="#">',
            b,
            "</a>",
      ...
      this.$pagination.html(l.join("")),
        this.options.onlyInfoPagination ||
          ((g = this.$pagination.find(".page-list a")),
          ...
          this.options.smartDisplay &&
            ...
            (o.length < 2 || this.options.totalRows <= o[0]) &&
              this.$pagination.find("span.page-list").hide(),
            this.$pagination[this.getData().length ? "show" : "hide"]()),
          this.options.paginationLoop ||
            (1 === this.options.pageNumber && h.addClass("disabled"),
            this.options.pageNumber === this.totalPages &&
              i.addClass("disabled")),
          m && (this.options.pageSize = this.options.formatAllRows()),
          g.off("click").on("click", a.proxy(this.onPageListChange, this)),
          h.off("click").on("click", a.proxy(this.onPagePre, this)),
          i.off("click").on("click", a.proxy(this.onPageNext, this)),
          j.off("click").on("click", a.proxy(this.onPageNumber, this)));
    }),
    (q.prototype.updatePagination = function (b) {
      (b && a(b.currentTarget).hasClass("disabled")) ||
    ...
    (q.prototype.onPageListChange = function (b) {
      ...
      return (
        ...
        (this.options.pageSize =
          c.text().toUpperCase() === this.options.formatAllRows().toUpperCase()
    ...
    (q.prototype.initRow = function (b, c) {
      ...
      if (!(a.inArray(b, this.hiddenRows) > -1)) {
        if (
          ((i = j(this.options, this.options.rowStyle, [b, c], i)), i && i.css)
        )
        ...
        return (
          b._data &&
            !a.isEmptyObject(b._data) &&
            a.each(b._data, function (a, b) {
              "index" !== a && (m += f(' data-%s="%s"', a, b));
            }),
          h.push(
            "<tr",
            f(" %s", p.join(" ")),
            f(' id="%s"', a.isArray(b) ? void 0 : b._id),
            f(' class="%s"', i.classes || (a.isArray(b) ? void 0 : b._class)),
            f(' data-index="%s"', c),
            f(' data-uniqueid="%s"', b[this.options.uniqueId]),
            f("%s", m),
            ">"
          ),
          ...
          !this.options.cardView &&
            ...
            (h.push("<td>"),
            j(null, this.options.detailFilter, [c, b]) &&
              h.push(
            ...
            h.push("</td>")),
          a.each(this.header.fields, function (d, m) {
            var o = "",
            ...
            if (
              (!e.fromHtml ||
                ...
                z.radio) &&
              z.visible &&
              (!e.options.cardView || z.cardVisible)
            ) {
              if (
                (z.escape && (p = l(p)),
                (i = f('style="%s"', k.concat(e.header.styles[d]).join("; "))),
                b["_" + m + "_id"] && (t = f(' id="%s"', b["_" + m + "_id"])),
                b["_" + m + "_class"] &&
                  (u = f(' class="%s"', b["_" + m + "_class"])),
                b["_" + m + "_rowspan"] &&
                  (w = f(' rowspan="%s"', b["_" + m + "_rowspan"])),
                b["_" + m + "_colspan"] &&
                  (x = f(' colspan="%s"', b["_" + m + "_colspan"])),
                b["_" + m + "_title"] &&
                  (y = f(' title="%s"', b["_" + m + "_title"])),
                (s = j(e.header, e.header.cellStyles[d], [p, b, c, m], s)),
                s.classes && (u = f(' class="%s"', s.classes)),
                s.css)
              ) {
                var A = [];
              ...
              (q = j(z, e.header.formatters[d], [p, b, c, m], p)),
                b["_" + m + "_data"] &&
                  !a.isEmptyObject(b["_" + m + "_data"]) &&
                  a.each(b["_" + m + "_data"], function (a, b) {
                    "index" !== a && (v += f(' data-%s="%s"', a, b));
                  }),
                z.checkbox || z.radio
                  ? ((r = z.checkbox ? "checkbox" : r),
                    (r = z.radio ? "radio" : r),
                    (o = [
                      f(
                        e.options.cardView
                      ...
                      "<input" +
                        f(' data-index="%s"', c) +
                        f(' name="%s"', e.options.selectItemName) +
                        f(' type="%s"', r) +
                        f(' value="%s"', b[e.options.idField]) +
                        f(
                          ' checked="%s"',
                          q === !0 || p || (q && q.checked) ? "checked" : void 0
                        ) +
                        f(
                          ' disabled="%s"',
                          !z.checkboxEnabled || (q && q.disabled)
                            ? "disabled"
                            : void 0
                        ) +
                        " />",
                      e.header.formatters[d] && "string" == typeof q ? q : "",
                      e.options.cardView ? "</div>" : "</td>",
                    ].join("")),
                    (b[e.header.stateField] =
                      q === !0 || !!p || (q && q.checked)))
                  : ((q =
                      "undefined" == typeof q || null === q
                        ? e.options.undefinedText
                        : q),
                    (o = e.options.cardView
                      ? [
                          '<div class="card-view">',
                          e.options.showHeader
                            ? f(
                                ...
                                i,
                                g(e.columns, "field", "title", m)
                              )
                            : "",
                          f('<span class="value">%s</span>', q),
                          "</div>",
                        ].join("")
                      : [
                          f("<td%s %s %s %s %s %s %s>", t, u, i, v, w, x, y),
                          q,
                          "</td>",
                        ].join("")),
                    e.options.cardView &&
                      e.options.smartDisplay &&
                      "" === q &&
                      (o = '<div class="card-view"></div>')),
                h.push(o);
            }
          }),
          this.options.cardView && h.push("</div></td>"),
          h.push("</tr>"),
          h.join(" ")
        );
      }
    ...
    (q.prototype.initBody = function (b) {
      var c = this,
        d = this.getData();
      this.trigger("pre-body", d),
        (this.$body = this.$el.find(">tbody")),
        this.$body.length ||
          (this.$body = a("<tbody></tbody>").appendTo(this.$el)),
        (this.options.pagination && "server" !== this.options.sidePagination) ||
          ((this.pageFrom = 1), (this.pageTo = d.length));
      for (
        var e, g = a(document.createDocumentFragment()), h = this.pageFrom - 1;
        h < this.pageTo;
        h++
      ) {
        var i = d[h],
      ...
      e ||
        ...
        this.$body
          ...
          .on("click dblclick", function (b) {
            ...
            if (
              !d.find(".detail-icon").length &&
              (c.trigger(
                "click" === b.type ? "click-cell" : "dbl-click-cell",
                j,
                l,
                g,
                d
              ...
              c.trigger(
                "click" === b.type ? "click-row" : "dbl-click-row",
                g,
                e,
                j
              ),
              "click" === b.type &&
                c.options.clickToSelect &&
                k.clickToSelect &&
                c.options.ignoreClickToSelectOn(b.target))
            ) {
          ...
          .on("click", function (b) {
            ...
            if (g.next().is("tr.detail-view"))
              e
                ...
                .attr(
                  "class",
                  f("%s %s", c.options.iconsPrefix, c.options.icons.detailOpen)
                ),
                c.trigger("collapse-row", h, i, g.next()),
                g.next().remove();
            else {
              e
                .find("i")
                .attr(
                  "class",
                  f("%s %s", c.options.iconsPrefix, c.options.icons.detailClose)
                ),
                g.after(
                  f(
        ...
        (this.$selectItem = this.$body.find(
          f('[name="%s"]', this.options.selectItemName)
        )),
        this.$selectItem.off("click").on("click", function (b) {
          ...
          (a(this).is(":radio") || c.options.singleSelect) &&
            a.each(c.options.data, function (a, b) {
              b[c.header.stateField] = !1;
            }),
            (f[c.header.stateField] = e),
            c.options.singleSelect &&
              (c.$selectItem.not(this).each(function () {
                c.data[a(this).data("index")][c.header.stateField] = !1;
              }),
              c.$selectItem.filter(":checked").not(this).prop("checked", !1)),
            c.updateSelected(),
            c.trigger(e ? "check" : "uncheck", f, d);
        }),
        a.each(this.header.events, function (b, d) {
          if (d) {
            ...
            if (-1 !== f) {
              ...
              for (var g in d)
                c.$body.find(">tr:not(.no-records-found)").each(function () {
                  var b = a(this),
    ...
    (q.prototype.initServer = function (b, c, d) {
      ...
      this.header.sortNames[h] && (i.sortName = this.header.sortNames[h]),
        ...
        (d || this.options.url || this.options.ajax) &&
            ...
            this.options.pagination &&
              ...
              (i.limit =
                this.options.pageSize === this.options.formatAllRows()
                  ? this.options.totalRows
                  : this.options.pageSize),
              0 === i.limit && delete i.limit)),
          a.isEmptyObject(this.filterColumnsPartial) ||
            (i.filter = JSON.stringify(this.filterColumnsPartial, null)),
          (g = j(this.options, this.options.queryParams, [i], g)),
          a.extend(g, c || {}),
          g !== !1 &&
            (b || this.$tableLoading.show(),
            (e = a.extend({}, j(null, this.options.ajaxOptions), {
              ...
              success: function (a) {
                (a = j(f.options, f.options.responseHandler, [a], a)),
                  f.load(a),
              ...
              error: function (a) {
                var c = [];
                "server" === f.options.sidePagination &&
                  ((c = {}),
                  (c[f.options.totalField] = 0),
                  (c[f.options.dataField] = [])),
                  f.load(c),
            ...
            this.options.ajax
              ? j(this, this.options.ajax, [e], null)
    ...
    (q.prototype.initSearchText = function () {
      if (
        ...
        a.val(this.options.searchText),
          this.onSearch({ currentTarget: a, firedByInitSearchText: !0 });
      }
    }),
    (q.prototype.getCaret = function () {
      ...
      a.each(this.$header.find("th"), function (c, d) {
        a(d)
          ...
          .addClass(
            a(d).data("field") === b.options.sortName
              ? b.options.sortOrder
              : "both"
          );
      });
    ...
    (q.prototype.updateSelected = function () {
      ...
      this.$selectAll.add(this.$selectAll_).prop("checked", b),
        this.$selectItem.each(function () {
          a(this)
            .closest("tr")
            [a(this).prop("checked") ? "addClass" : "removeClass"]("selected");
        });
    }),
    (q.prototype.updateRows = function () {
      var b = this;
      this.$selectItem.each(function () {
        b.data[a(this).data("index")][b.header.stateField] =
          a(this).prop("checked");
      });
    }),
    ...
    (q.prototype.trigger = function (b) {
      ...
      (b += ".bs.table"),
        this.options[q.EVENTS[b]].apply(this.options, c),
    ...
    (q.prototype.fitHeader = function () {
      var b,
        ...
        g = this;
      if (g.$el.is(":hidden"))
        return void (g.timeoutId_ = setTimeout(a.proxy(g.fitHeader, g), 100));
      if (
        ((b = this.$tableBody.get(0)),
        (c =
          b.scrollWidth > b.clientWidth &&
          b.scrollHeight > b.clientHeight + this.$header.outerHeight()
            ? i()
            : 0),
      ...
      (this.$header_ = this.$header.clone(!0, !0)),
        ...
        this.$tableHeader
          ...
          .append(this.$header_),
        (e = a(".focus-temp:visible:eq(0)")),
        e.length > 0 &&
          (e.focus(),
          this.$header.find(".focus-temp").removeClass("focus-temp")),
        this.$header.find("th[data-field]").each(function () {
          g.$header_
            .find(f('th[data-field="%s"]', a(this).data("field")))
            .data(a(this).data());
        });
    ...
    (q.prototype.resetFooter = function () {
      ...
      this.options.showFooter &&
        ...
        a.each(this.columns, function (a, e) {
          var g,
            h = "",
            i = "",
            k = [],
          ...
          if (e.visible && (!b.options.cardView || e.cardVisible)) {
            if (
              ((h = f("text-align: %s; ", e.falign ? e.falign : e.align)),
              (i = f("vertical-align: %s; ", e.valign)),
              (l = j(null, b.options.footerStyle)),
              l && l.css)
            )
            ...
            d.push(
              "<td",
              m,
              f(' style="%s"', h + i + k.concat().join("; ")),
              ">"
            ),
              d.push('<div class="th-inner">'),
              d.push(j(e, e.footerFormatter, [c], "&nbsp;") || "&nbsp;"),
              d.push("</div>"),
              d.push('<div class="fht-cell"></div>'),
              d.push("</div>"),
              d.push("</td>");
    ...
    (q.prototype.fitFooter = function () {
      ...
      return (
        clearTimeout(this.timeoutFooter_),
        this.$el.is(":hidden")
          ? void (this.timeoutFooter_ = setTimeout(
              a.proxy(this.fitFooter, this),
              100
            ))
          : ((c = this.$el.css("width")),
            (d = c > this.$tableBody.width() ? i() : 0),
            this.$tableFooter
              .css({ "margin-right": d })
              .find("table")
              .css("width", c)
    ...
    (q.prototype.horizontalScroll = function () {
      var b = this;
      b.trigger("scroll-body"),
        this.$tableBody.off("scroll").on("scroll", function () {
          b.options.showHeader &&
            b.options.height &&
            b.$tableHeader.scrollLeft(a(this).scrollLeft()),
            b.options.showFooter &&
              !b.options.cardView &&
              b.$tableFooter.scrollLeft(a(this).scrollLeft());
        });
    }),
    (q.prototype.toggleColumn = function (a, b, c) {
      if (
        ...
        c && d.filter(f('[value="%s"]', a)).prop("checked", b),
          d.filter(":checked").length <= this.options.minimumCountColumns &&
            d.filter(":checked").prop("disabled", !0);
      }
    }),
    ...
    (q.prototype.getData = function (b) {
      ...
      return (
        (this.searchText ||
          ...
          !a.isEmptyObject(this.filterColumnsPartial)) &&
          (c = this.data),
        b ? c.slice(this.pageFrom - 1, this.pageTo) : c
      );
    }),
    (q.prototype.load = function (b) {
      var c = !1;
      this.options.pagination && "server" === this.options.sidePagination
        ? ((this.options.totalRows = b[this.options.totalField]),
          (c = b.fixedScroll),
          (b = b[this.options.dataField]))
        : a.isArray(b) || ((c = b.fixedScroll), (b = b.data)),
        this.initData(b),
        this.initSearch(),
        this.initPagination(),
        this.initBody(c);
      ...
      if (b.hasOwnProperty("field") && b.hasOwnProperty("values")) {
        for (c = e - 1; c >= 0; c--)
          (d = this.options.data[c]),
            d.hasOwnProperty(b.field) &&
              -1 !== a.inArray(d[b.field], b.values) &&
              (this.options.data.splice(c, 1),
              "server" === this.options.sidePagination &&
    ...
    (q.prototype.updateByUniqueId = function (b) {
      ...
      a.each(d, function (b, d) {
        var e;
        d.hasOwnProperty("id") &&
          d.hasOwnProperty("row") &&
          ((e = a.inArray(c.getRowByUniqueId(d.id), c.options.data)),
    ...
    (q.prototype.refreshColumnTitle = function (b) {
      if (
        ...
        ((this.columns[this.fieldsColumnsIndex[b.field]].title = this.options
          .escape
          ? l(b.title)
          : b.title),
        this.columns[this.fieldsColumnsIndex[b.field]].visible)
      ) {
        var c =
          void 0 !== this.options.height ? this.$tableHeader : this.$header;
        c.find("th[data-field]").each(function () {
          return a(this).data("field") === b.field
            ? (a(a(this).find(".th-inner")[0]).text(b.title), !1)
            : void 0;
        });
      }
    }),
    (q.prototype.insertRow = function (a) {
      a.hasOwnProperty("index") &&
        a.hasOwnProperty("row") &&
        (this.options.data.splice(a.index, 0, a.row),
        this.initSearch(),
        this.initPagination(),
        this.initSort(),
        this.initBody(!0));
    ...
    (q.prototype.toggleRow = function (b, c) {
      var d, e;
      b.hasOwnProperty("index")
        ? (d = this.getData()[b.index])
        : b.hasOwnProperty("uniqueId") &&
          (d = this.getRowByUniqueId(b.uniqueId)),
        d &&
          ((e = a.inArray(d, this.hiddenRows)),
          c || -1 !== e
            ? c && e > -1 && this.hiddenRows.splice(e, 1)
            : this.hiddenRows.push(d),
          this.initBody(!0));
    }),
    ...
    (q.prototype.updateCell = function (a) {
      a.hasOwnProperty("index") &&
        ...
        ((this.data[a.index][a.field] = a.value),
    ...
    (q.prototype.check_ = function (a, b) {
      var c = this.$selectItem
        .filter(f('[data-index="%s"]', b))
        .prop("checked", a);
      ...
      if (c.hasOwnProperty("field") && c.hasOwnProperty("values")) {
        ...
        a.each(this.options.data, function (g, h) {
          ...
          if (-1 !== a.inArray(h[c.field], c.values)) {
            var i = d.$selectItem
              .filter(":enabled")
              .filter(f('[data-index="%s"]', g))
              .prop("checked", b);
            (h[d.header.stateField] = b),
              e.push(h),
              d.trigger(b ? "check" : "uncheck", h, i);
          }
        }),
          this.updateSelected(),
    ...
    (q.prototype.scrollTo = function (a) {
      return (
        "string" == typeof a &&
          (a = "bottom" === a ? this.$tableBody[0].scrollHeight : 0),
    ...
    (q.prototype.selectPage = function (a) {
      a > 0 &&
        ...
        ((this.options.pageNumber = a), this.updatePagination());
    }),
    ...
    (q.prototype.toggleView = function () {
      ...
      this.options.cardView
        ? (a.removeClass(this.options.icons.toggleOff),
          a.addClass(this.options.icons.toggleOn))
        : (a.removeClass(this.options.icons.toggleOn),
          a.addClass(this.options.icons.toggleOff)),
        this.initBody(),
    ...
    (q.prototype.expandRow_ = function (a, b) {
      ...
      c.next().is("tr.detail-view") === (a ? !1 : !0) &&
        c.find("> td > .detail-icon").click();
    }),
    ...
    (q.prototype.expandAllRows = function (b) {
      if (b) {
        var c = this.$body.find(f('> tr[data-index="%s"]', 0)),
          ...
          h = -1;
        if (
          (c.next().is("tr.detail-view")
            ? c.next().next().is("tr.detail-view") ||
              (c.next().find(".detail-icon").click(), (g = !0))
            : (c.find("> td > .detail-icon").click(), (g = !0)),
          g)
        )
          try {
            h = setInterval(function () {
              (e = d.$body.find("tr.detail-view").last().find(".detail-icon")),
                e.length > 0 ? e.click() : clearInterval(h);
            }, 1);
          } catch (i) {
            clearInterval(h);
          }
    ...
    (q.prototype.updateFormatText = function (a, b) {
      this.options[f("format%s", a)] &&
        ("string" == typeof b
          ? (this.options[f("format%s", a)] = function () {
              return b;
            })
          : "function" == typeof b && (this.options[f("format%s", a)] = b)),
        this.initToolbar(),
        this.initPagination(),
        this.initBody();
    });
  ...
  (a.fn.bootstrapTable = function (b) {
    ...
    (a.fn.bootstrapTable.Constructor = q),
    (a.fn.bootstrapTable.defaults = q.DEFAULTS),
    (a.fn.bootstrapTable.columnDefaults = q.COLUMN_DEFAULTS),
    (a.fn.bootstrapTable.locales = q.LOCALES),
    (a.fn.bootstrapTable.methods = r),
    ...
    a(function () {
      a('[data-bs-toggle="table"]').bootstrapTable();
    });
})(jQuery);
